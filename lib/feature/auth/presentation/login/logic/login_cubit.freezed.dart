...
mixin _$LoginState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(ApiErrorModel failure) failure,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(ApiErrorModel failure)? failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class _$$FailureImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({ApiErrorModel failure});
}
...
abstract class Failure<T> implements LoginState<T> {
  const factory Failure({required final ApiErrorModel failure}) =
      _$FailureImpl<T>;
